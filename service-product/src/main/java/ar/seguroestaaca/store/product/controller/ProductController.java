package ar.seguroestaaca.store.product.controller;

import ar.seguroestaaca.store.product.entity.Category;
import ar.seguroestaaca.store.product.entity.Product;
import ar.seguroestaaca.store.product.service.ProductService;
import ar.seguroestaaca.store.product.utils.Validations;
...
public class ProductController {
    ...
    public ResponseEntity<Product> createProduct(@Valid @RequestBody Product product, BindingResult result){
        if (result.hasErrors()){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, Validations.formatMessage(result));
        }
